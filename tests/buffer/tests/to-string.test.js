// Based on https://github.com/feross/buffer/blob/master/test/to-string.js
...
test.skip('utf16le to utf16', function (t) {
  t.equal(
...
test.skip('utf16le to utf16 with odd byte length input', function (t) {
  t.equal(
...
test.skip('utf16le to hex', function (t) {
  t.equal(
...
// Node.js disagrees
test.skip('utf8 replacement chars on 256 random bytes', function (t) {
  t.equal(
